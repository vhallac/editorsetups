...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
 '(default ((t (:background "#00005f" :foreground "white" :height 88 :foundry "unknown" :family "DejaVu Sans Mono"))))
